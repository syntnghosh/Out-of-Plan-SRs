...
SR_History <- read_excel("Fixed_Plan_Out_of_Coverage_SRs_dataset_09102019.xlsx",
                   sheet = "SR Details")

SWM <- read_excel("Fixed_Plan_Out_of_Coverage_SRs_dataset_09102019.xlsx",
                  sheet = "SWM")
...
colnames(SR_History)<-c("SRNum","CustNum","SRSiteNum","SRSiteState","SRCreateDate","SRWorkDate","SRPMGroup","SRShortDescription","SRInvoiceStatus","SRSubstatus",
